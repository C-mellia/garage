...
typedef struct input_tok_pipe {
    ...
    struct {
        ...
        struct {
            ...
            int *(*tok_stream_engine_produce) (void *engine_data, void *buf, size_t len, size_t align);
    ...
    struct {
        ...
        struct {
            ...
            int *(*fd_stream_engine_produce) (void *engine_data, void *buf, size_t len, size_t align);
...
int input_tok_pipe_deb_dprint(int fd, InputTokPipe tok_pipe);
int input_tok_pipe_deb_print(InputTokPipe tok_pipe);
